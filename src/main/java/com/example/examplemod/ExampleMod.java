...
public class ExampleMod implements ModInitializer, ClientModInitializer {
    ...
    public static final EntityType<GiantSpiderBoss> GIANT_SPIDER = Registry.register(
            ...
            FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, GiantSpiderBoss::new)
                    .dimensions(EntityDimensions.fixed(7.0f, 4.5f)) // Хитбокс под размер x5
                    .build()
    );

    // Регистрация яйца призыва (Серое с красным)
    ...
    public void onInitializeClient() {
        // Визуальное увеличение модели в 5 раз
    ...
    public static class GiantSpiderBoss extends SpiderEntity {
        private final ServerBossBar bossBar = new ServerBossBar(
                Text.literal("Король Пауков"), BossBar.Color.RED, BossBar.Style.NOTCHED_10);
        ...
        public static DefaultAttributeContainer.Builder createAttributes() {
            return SpiderEntity.createSpiderAttributes()
                    .add(EntityAttributes.GENERIC_MAX_HEALTH, 200.0) // 200 ХП
                    .add(EntityAttributes.GENERIC_ATTACK_DAMAGE, 4.0) // 4 урона
                    .add(EntityAttributes.GENERIC_ARMOR, 15.0)       // Броня
                    .add(EntityAttributes.GENERIC_KNOCKBACK_RESISTANCE, 1.0); // Сопротивление отбрасыванию
        }
        ...
        public void mobTick() {
            ...
            // Логика миньонов: меньше 30% ХП, каждые 5 секунд
